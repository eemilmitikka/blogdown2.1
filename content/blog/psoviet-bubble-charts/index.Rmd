...
Now our interactive plot is ready: life expectancy is displayed on the Y-axis, GDP per capita on the X-axis, bubbles capture the population size, and colors depict the country groups. Here, "CIS" refers to the "[Commonwealth of Independent States](https://en.wikipedia.org/wiki/Commonwealth_of_Independent_States)", "EU-partner" refers to "[European Union's Eastern Partnership](https://en.wikipedia.org/wiki/Eastern_Partnership)" countries, and "EU" refers to the "[European Union](https://en.wikipedia.org/wiki/European_Union)". "CIS-country & EU-partner", in turn, depicts countries that are both Eastern Partnership countries and members of the Commonwealth of Independent States (NB: Belarus is suspended from the former, and hence displayed only as a "CIS-country").
