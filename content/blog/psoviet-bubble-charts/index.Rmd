...
external_link: ""
image:
  caption: Image is screenshot from Gapminder's webpage
  focal_point: Smart
links:
...
soviet_fig <- soviet_fig %>%
  layout(title = "Life expectancy, GDP per capita and population\nin post-Soviet countries (1995-2019)",
         xaxis = list(title = "GDP per capita (in constant international-$)"),
         yaxis = list(title = "Life expectancy (in year)"),
...
Now we are done, and the next step is to apply your own data. Thanks for reading, hopefully you found these instructions useful and interesting! yeyes gdsgdsggdsgds
